...
/**
 * Função que valida um arquivo de remessa ou retorno Bradesco Multipag de 400 posições.
 *
 ...
 */
function validarArquivoBradescoMultipag400(arquivo) {
...
readFile(`${nomeDirRem}/${nomeArquivo}`, 'utf8', (err, data) => {
  ...
  validarArquivoBradescoMultipag400(data);
});